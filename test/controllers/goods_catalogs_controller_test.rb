...
class GoodsCatalogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create goods_catalog" do
    assert_difference('GoodsCatalog.count') do
      post goods_catalogs_url, params: { goods_catalog: { code: @goods_catalog.code, name: @goods_catalog.name } }
    end
  ...
  test "should update goods_catalog" do
    patch goods_catalog_url(@goods_catalog), params: { goods_catalog: { code: @goods_catalog.code, name: @goods_catalog.name } }
