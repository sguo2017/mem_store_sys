...
class Phone::HomepagesControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create homepage" do
    ...
    assert_redirected_to phone_homepage_path(assigns(:homepage))
  end
  ...
  test "should destroy homepage" do
    ...
    assert_redirected_to phone_homepages_path
  end
end
